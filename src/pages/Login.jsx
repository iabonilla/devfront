...
export default function Login() {
    ...
    const navegacion = () => {
        navigate('/main')
        console.log("Navegaaaaaaaaaar");
        
    } 
  return (

    <section className="min-h-screen flex items-stretch text-white ">
      <div onSubmit={(e) => e.preventDefault()} className="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center">
      ...
      <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0">
        ...
        <div className="w-full py-6 z-20">
          ...
          {/* <img src={imgurl.imglogin} alt="" /> */}
          <p className="text-gray-100">or use email your account</p>
          <form onSubmit={(e) => e.preventDefault()} className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
            ...
            <div className="px-4 pb-2 pt-4">
              <button onClick={navegacion} className="uppercase block w-full p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none">
                sign in
              </button>
            </div>
